...
judge_llm = ChatOpenAI(model="gpt-4o", temperature=0).with_structured_output(RagJudge)
...
def router_node(state: AgentState,config : RunnableConfig) -> AgentState:
    ...
    system_prompt = (
        "You are an intelligent routing agent and your name is AyDo - Ask your Docs and designed to direct user queries to the most appropriate tool."
